...
pub const __FreeBSD_version: i32 = 1500048;
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of mod_depend"][::core::mem::size_of::<mod_depend>() - 12usize];
    ["Alignment of mod_depend"][::core::mem::align_of::<mod_depend>() - 4usize];
    ["Offset of field: mod_depend::md_ver_minimum"]
        [::core::mem::offset_of!(mod_depend, md_ver_minimum) - 0usize];
    ["Offset of field: mod_depend::md_ver_preferred"]
        [::core::mem::offset_of!(mod_depend, md_ver_preferred) - 4usize];
    ["Offset of field: mod_depend::md_ver_maximum"]
        [::core::mem::offset_of!(mod_depend, md_ver_maximum) - 8usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct mod_metadata {
    ...
    pub md_data: *const libc::c_void,
    pub md_cval: *const libc::c_char,
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of mod_metadata"][::core::mem::size_of::<mod_metadata>() - 24usize];
    ["Alignment of mod_metadata"][::core::mem::align_of::<mod_metadata>() - 8usize];
    ["Offset of field: mod_metadata::md_version"]
        [::core::mem::offset_of!(mod_metadata, md_version) - 0usize];
    ["Offset of field: mod_metadata::md_type"]
        [::core::mem::offset_of!(mod_metadata, md_type) - 4usize];
    ["Offset of field: mod_metadata::md_data"]
        [::core::mem::offset_of!(mod_metadata, md_data) - 8usize];
    ["Offset of field: mod_metadata::md_cval"]
        [::core::mem::offset_of!(mod_metadata, md_cval) - 16usize];
};
...
pub const sysinit_sub_id_SI_SUB_KHELP: sysinit_sub_id = 34078720;
...
pub const sysinit_sub_id_SI_SUB_EPOCH: sysinit_sub_id = 42500096;
...
pub type sysinit_sub_id = libc::c_uint;
...
pub type sysinit_elem_order = libc::c_uint;
pub type sysinit_cfunc_t = ::core::option::Option<unsafe extern "C" fn(arg1: *const libc::c_void)>;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct sysinit {
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of sysinit__bindgen_ty_1"][::core::mem::size_of::<sysinit__bindgen_ty_1>() - 8usize];
    ["Alignment of sysinit__bindgen_ty_1"]
        [::core::mem::align_of::<sysinit__bindgen_ty_1>() - 8usize];
    ["Offset of field: sysinit__bindgen_ty_1::stqe_next"]
        [::core::mem::offset_of!(sysinit__bindgen_ty_1, stqe_next) - 0usize];
};
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of sysinit"][::core::mem::size_of::<sysinit>() - 32usize];
    ["Alignment of sysinit"][::core::mem::align_of::<sysinit>() - 8usize];
    ["Offset of field: sysinit::subsystem"][::core::mem::offset_of!(sysinit, subsystem) - 0usize];
    ["Offset of field: sysinit::order"][::core::mem::offset_of!(sysinit, order) - 4usize];
    ["Offset of field: sysinit::next"][::core::mem::offset_of!(sysinit, next) - 8usize];
    ["Offset of field: sysinit::func"][::core::mem::offset_of!(sysinit, func) - 16usize];
    ["Offset of field: sysinit::udata"][::core::mem::offset_of!(sysinit, udata) - 24usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct thread {
